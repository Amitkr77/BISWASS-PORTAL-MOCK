export function ChevronDownIcon({ className = 'w-3.5 h-3.5 shrink-0' }) {
  return (
...
export function LoginIcon({ className = 'w-4 h-4' }) {
  return (
    <svg className={className} viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
      <path fillRule="evenodd" d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a1 1 0 10-2 0v1h-1a1 1 0 100 2h1v1a1 1 0 102 0v-1h1a1 1 0 100-2h-1V6zM2 18a5 5 0 0110 0 1 1 0 01-1 1H3a1 1 0 01-1-1z" clipRule="evenodd" />
    </svg>
  );
}

export function ChevronPrevIcon({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
...
export function ChevronNextIcon({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
...
export function BellIcon({ className = 'w-4 h-4 text-govt-red shrink-0' }) {
  return (
    <svg className={className} viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
      <path fillRule="evenodd" d="M4 2a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V7.414A2 2 0 0017.414 6L14 2.586A2 2 0 0012.586 2H4zm3 10a1 1 0 011-1h4a1 1 0 110 2H8a1 1 0 01-1-1zm1-4a1 1 0 100 2h4a1 1 0 100-2H8z" clipRule="evenodd" />
    </svg>
  );
}

export function ClockIcon({ className = 'w-8 h-8 text-violet-800/70' }) {
  return (
...
export function CheckCircleIcon({ className = 'w-8 h-8 text-violet-800/70' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4" aria-hidden="true">
...
export function InfoIcon({ className = 'w-5 h-5 text-violet-800' }) {
  return (
    <svg className={className} viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
...
export function SearchIcon({ className = 'w-4 h-4 text-govt-gray-400' }) {
  return (
    <svg className={className} viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
...
export function CheckIcon({ className = 'w-5 h-5 text-govt-green shrink-0 mt-0.5' }) {
  return (
    <svg className={className} viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
...
export function ArrowUpIcon({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
      <path fillRule="evenodd" d="M10 3a.75.75 0 01.53.22l5.25 5.25a.75.75 0 01-1.06 1.06L10.75 5.56v10.69a.75.75 0 01-1.5 0V5.56L5.28 9.53a.75.75 0 01-1.06-1.06l5.25-5.25A.75.75 0 0110 3z" clipRule="evenodd" />
    </svg>
  );
}
...
export function EditIcon({ className = 'w-4 h-4' }) {
  return (
    <svg className={className} viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
      <path d="M13.586 3.586a2 2 0 012.828 2.828l-.793.793-2.828-2.828.793-.793z" />
      <path fillRule="evenodd" d="M11.379 5.207L3 13.586V17h3.414l8.379-8.379-3.414-3.414zM4.5 15.5v-1.293l7.879-7.879 1.293 1.293-7.879 7.879H4.5z" clipRule="evenodd" />
    </svg>
  );
}
...
export function RestoreIcon({ className = 'w-4 h-4' }) {
  return (
    <svg className={className} viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.6" aria-hidden="true">
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 8a7 7 0 1112.32 4.65M3 8V4M3 8h4" />
    </svg>
  );
}
...
export function LogOutIcon({ className = 'w-4 h-4' }) {
  return (
    <svg className={className} viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.6" aria-hidden="true">
      <path strokeLinecap="round" strokeLinejoin="round" d="M7 4H4.5A1.5 1.5 0 003 5.5v9A1.5 1.5 0 004.5 16H7M13 13l4-3-4-3M17 10H7" />
    </svg>
  );
}
